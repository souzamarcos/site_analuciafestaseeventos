...
},{"bootstrap-sass":1,"jquery":2}],4:[function(require,module,exports){
'use strict';
...
var Home = function () {
    ...
    _createClass(Home, null, [{
        key: 'AtualizarBackroundNav',
        value: function AtualizarBackroundNav() {
...
$(document).ready(function () {
    ...
    $(window).scroll(function (event) {
        ...
        if ($(window).scrollTop() > Home.lastScrollTop) {
            // downscroll code
...
var Mapa = function () {
    ...
    _createClass(Mapa, [{
        key: 'InicarMapa',
        value: function InicarMapa(elment) {
            var self = this;

            self.mapa = new google.maps.Map(elment, {
                zoom: 4,
